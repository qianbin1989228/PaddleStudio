...
def get_server_info(server_info={}):
    '''获取服务器信息'''
    server_info['systemName'] = platform.system()
    server_info['systemVersion'] = platform.version()
    server_info['systemArch'] = platform.architecture()
    server_info['pythonVersion'] = platform.python_version()
    server_info['cudnnVersion'] = paddle.device.get_cudnn_version()
    server_info['cudaVersion'] = paddle.version.cuda()
    server_info['paddleVersion'] = paddle.__version__
    return server_info
